...
function mudarCorQuadrado(quadrado1,quadrado2,quadrado3){
    quadrado1.style.background = '#1bf707'
    quadrado2.style.background = '#1bf707'
    quadrado3.style.background = '#1bf707'
}
...
function reiniciar() {
    ...
    for (var i= 1; i<= 9; i++){
        ...
        quadrado.style.background='#d9c0ee';
        quadrado.style.color = '#d9c0ee';
        quadrado.innerHTML = '-';
    }
    mudarJogador('X');
}